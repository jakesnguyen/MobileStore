        ...
        %>
         ...
         <div class="emptyCart">
                <div class="emptyCart_img">
                    <img style="width:100%" src="http://www.sclance.com/pngs/sorry-png/sorry_png_1277920.jpg" alt="Empty" />
                </div>
                <h1 class="emptyCart_title">There is no stuff inside your shop cart.</h1>
                <form action="productPage" method ="get">
                    <button type="submit" class="emptyCart_btn"> Keep buying</button>
                </form>
